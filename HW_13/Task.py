...
class Student:
    ...
    def __repr__(self):
        result = f'''Студент:
Ф.И.О. = "{self.name} {self.second_name} {self.surname}"
средняя оценка = {self.lessons["middle_estimate"]}\n'''
...
if __name__ == '__main__':
    iii = Student("Иванов", "Иван", "Иванович", Path('lessons.csv'))
    iii.new_estimate("русский язык", 3)
    iii.new_estimate("информатика", 5)
    iii.new_estimate("физика", 2)
    iii.new_estimate("физика", 4)
    iii.new_estimate("математика", 5)
    iii.new_estimate("русский язык", 2)
    iii.new_estimate("информатика", 3)
    iii.new_estimate("физика", 5)
    iii.new_estimate("физика", 2)
    iii.new_estimate("математика", 4)
    iii.new_estimate("математика", 68, "test")
    iii.new_estimate("математика", 99, "test")
    iii.new_estimate("русский язык", 29, "test")
    iii.new_estimate("русский язык", 100, "test")
    iii.new_estimate("английский язык", 18, "test")
    iii.new_estimate("английский язык", 74, "test")
    iii.new_estimate("информатика", 39, "test")
    iii.new_estimate("информатика", 89, "test")
    print(iii)