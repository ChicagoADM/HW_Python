...
if __name__ == '__main__':
    ...
    mik.new_estimate("английский язык", 18, "test")
    mik.new_estimate("английский язык", 74, "test")
    mik.new_estimate("информатика", 39, "test")
    mik.new_estimate("информатика", 89, "test")
    print(mik)